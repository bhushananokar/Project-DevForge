...
const TOPOLOGIES: Record<string, { name: string; description: string; agents: string[] }> = {
  coding_swarm: {
    name: "Coding Swarm",
    description: "Feasibility gate → Planner → Backend/Frontend Engineers → Critic.",
    agents: [
      "reality_check",
      "human_liaison",
      "orchestrator",
  ...
  software_delivery: {
    ...
    description: "Full SDLC lifecycle — all agents: discovery through deploy, QA, release, and observability.",
    agents: [
      "chief_orchestrator",
      "memory_agent",
      "product_manager",
  ...
  software_delivery_lite: {
    name: "Software Delivery (Lite)",
    description: "8-agent consolidated lifecycle — same phases, lower cost, faster smoke tests.",
    agents: [
      "chief_orchestrator",
      "memory_agent",
      "product_manager",
  ...
  research_swarm: {
    name: "Research Swarm",
    description: "Web research → summarization → critique for discovery tasks.",
    agents: ["orchestrator", "researcher", "summarizer", "critic"],
  },
  simple_chat: {
    name: "Simple Chat",
    description: "Single summarizer agent — fast, low-cost Q&A or small tasks.",
    agents: ["summarizer"],
  },
};
